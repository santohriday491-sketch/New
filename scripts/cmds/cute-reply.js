...
const TRIGGERS = [
  ...
  // 🟢 FARHAN SYSTEM
  {
    words: ["মালয়েশিয়া সিঙ্গেল বয়","মালয়েশিয়া সিঙ্গেল বয়","মালয়েশিয়া সিঙ্গেল বয়","মালয়েশিয়া সিঙ্গেল বয়"],

    texts: [
      "👉 মালয়েশিয়া সিঙ্গেল বয় বস এখন বিজি জা বলার আমাকে বলতে পারেন_!!😼🥰",
      "🔥 বস মালয়েশিয়া সিঙ্গেল বয় কে ডাকিস না পারলে একটা জি এফ দে...!😃",
      "😎 চুমু খাওয়ার বয়স টা আমার বস ফারহান চকলেট🍫খেয়ে উড়িয়ে দিল 🤗",
      "👉 আমার বস ♻️ মালয়েশিয়া সিঙ্গেল বয় এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো https://www.facebook.com/share/18mHmz3Anh/ 🔰 ♪√বস ফ্রি হলে আসবে🧡😁😜"
    ],
  ...
  // 🤖 MENTION SYSTEM
  {
    ...
    replies: [
      ...
      {
        text: "😽 আমি একটা বট, বস মালয়েশিয়া সিঙ্গেল বয় বানাইছে 😎",
